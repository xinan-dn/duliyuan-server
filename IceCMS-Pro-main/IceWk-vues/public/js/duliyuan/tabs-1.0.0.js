...
(function (a) {
  ...
  var b = {
    "default": function (a, b) {
      var c = this.getConf();
      this.getPanes().hide().removeClass(c.activetab).eq(a).show().addClass(c.activetab), b.call()
    }, fade: function (a, b) {
      var c = this.getConf(), d = c.fadeOutSpeed, e = this.getPanes();
      d ? e.fadeOut(d).removeClass(c.activetab) : e.hide().removeClass(c.activetab), e.eq(a).fadeIn(c.fadeInSpeed, b).addClass(c.activetab)
    }, slide: function (a, b) {
      var c = this.getConf();
      this.getPanes().slideUp(c.slideUpSpeed).removeClass(c.activetab), this.getPanes().eq(a).slideDown(c.slideDownSpeed, b).addClass(c.activetab)
    }, ajax: function (a, b) {
